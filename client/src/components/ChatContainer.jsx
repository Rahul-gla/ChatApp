...
const ChatContainer = ({ selectedUser, setSelectedUser }) => {
  ...
  }, [messagesDummyData]); // Added dependency to ensure scrolling works when messages change
        ...
        {messagesDummyData.map((msg, index) => (
          ...
          >
            {msg.image ? (
              ...
              <p
                className={`p-2 max-w-[200px] md:text-sm font-light rounded-lg mb-2 break-all bg-violet-500/30 text-white ${
                  msg.senderId === "6890fdvhfbhvbfrifbrifrifr" ? "rounded-br-none" : "rounded-bl-none"
                }`}
              >
                {msg.text}
              </p>
            ...
            <div className="text-center text-xs">
              <img
                src={msg.senderId === "6890fdvhfbhvbfrifbrifrifr" ? assets.avatar_icon : assets.profile_martin}
                alt=""
