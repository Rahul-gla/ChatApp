...
const Sidebar = ({ selectedUser, setSelectedUsser }) => {
    ...
    >
      ...
      <div className="flex flex-col">
        {userDummyData.map((user,index)=>(
          <div onClick={()=>{setSelectedUsser(user)}}
           key={index} className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer maxx-sm:text-sm ${selectedUser?._id==user._id&&'bg-[#282142]/50'}`}>
